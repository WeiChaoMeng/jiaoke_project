 ...
 * @date 2018/10/9 9:41
 */
public interface OaMainDeliveryService {
     ...
     * @return list
     */
    List<OaMainDelivery> selectAllData();
     ...
     */
    OaMainDelivery selectByName(String name);
     ...
     * @return int
     */
    int updateMainUser(String mainId, String[] array);
