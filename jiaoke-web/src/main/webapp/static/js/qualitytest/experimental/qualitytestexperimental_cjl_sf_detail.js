layui.use(['form', 'table', 'laydate', 'element'], function () {
    ...
    myform.init_GZSY_Value = function () {
        ...
        if (CLL_SF_GZ_Value.sxhsyzl_value1 > 0) {
            tgl_value1 = (((CLL_SF_GZ_Value.gzsyzl_value1 - CLL_SF_GZ_Value.sxhsyzl_value1) / CLL_SF_GZ_Value.gzsyzl_value1) * 100)
                .toFixed(1);
        }
        $("#0075tgl_value1").html(tgl_value1);
        var tgl_value2 = 0;
        if (CLL_SF_GZ_Value.gzsyzl_value2 > 0) {
            tgl_value2 = (((CLL_SF_GZ_Value.gzsyzl_value2 - CLL_SF_GZ_Value.sxhsyzl_value2) / CLL_SF_GZ_Value.gzsyzl_value2) * 100)
                .toFixed(1);
        }
        ...
        $("#0075tgl_value_pj").html(((Number(tgl_value1) + Number(tgl_value2)) / tgl_count).toFixed(1));
    ...
    myform.computeValue = function () {
        ...
        $("#kcshlzl_value1").html(Number(kcshlzl_value1));
        var kcshlzl_value2 = (CLL_SF_GZ_Value.gzsyzl_value2 - sh_value2).toFixed(1);
        $("#kcshlzl_value2").html(Number(kcshlzl_value2));
    }
