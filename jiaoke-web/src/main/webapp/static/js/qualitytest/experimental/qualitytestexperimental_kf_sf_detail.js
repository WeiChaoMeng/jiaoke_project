layui.use(['form', 'table', 'laydate', 'element'], function() {
	...
	console.log("qualitytestexperimental_kf_sf_detail.js");
	form.render();
	...
	myform.init_GZSY_Value = function() {
		//干燥试样总量/水洗后筛上总量
		CLL_SF_GZ_Value.syzl_value1 = myform.getItemValue('100002');
		CLL_SF_GZ_Value.syzl_value2 = myform.getItemValue('100003');
		//干燥试样总量/水洗后筛上总量 
		$("#syzl_value1").html(CLL_SF_GZ_Value.syzl_value1);
		$("#syzl_value2").html(CLL_SF_GZ_Value.syzl_value2);
	...
	myform.savaReport = function() {
		...
		$.ajax({
			...
			async: false,
			data: saveData,
			url: basePath + "/QualityTestExperimentalValueKfSf/save.do",
			dataType: 'json',
			success: function(msg) {
				if (msg.code == 200) {
					result = true;
