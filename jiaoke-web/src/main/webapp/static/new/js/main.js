...
function selectedCode() {
    $('#modalWindow').html('<div id="layerDemo" style="width: 200px;height: 200px;display: none;">\n' +
        '    <img style="width:100%;height:100%;background-color: #fff" src="/static/images/logo/AppCode20200615.png" alt="移动端二维码">\n' +
        '</div>');
...
/**-------------------人事管理start-------------------*/
//删除员工信息
function deletePersonnel(id, currentPage,itselfFrameId) {
    //提示窗
    layer.confirm('确认后关联的合同也会被删除！', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data === 'success') {
                        layer.msg('删除成功！');
                        $("#" + itselfFrameId)[0].contentWindow.reloadPersonnelPage(1);
                    } else {
                        layer.msg('删除失败！')
                    }
                },
...
function personnelDetails(id) {
    $('#modalWindow').html('<div id="userDetails" style="display: none;padding: 20px;">\n' +
