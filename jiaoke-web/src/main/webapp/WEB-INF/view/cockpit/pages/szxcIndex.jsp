...
<div id="ToolBar-Panel" >
    ...
    <div class="jimu-list jimu-toolbar-middle" id="jimu-list">
    	<ul id="jimu-list-ul" class="jimu-list-ul">
            ...
            <li><a href="/qualityCockpitPage.do"><span class="">质量管控</span></a></li>
            <li class="jimu-list-ul-li-select">实验管理</li>
...
<div class="model-content">
    ...
    <div class="comtab">
        <div class="modelpub">
            ...
            <div class="echart_con" id="xctj" style="height: 160px">

            </div>
        </div>
        <div class="modelpub1 margin20" >
            <div class="common-tit">标题</div>
            <span class="tilt"></span>
            <div class="echart_con1"  id='xccslc' style="height: 350px">
    ...
    <div class="comtab">
        <div class="modelpub">
            <div class="common-tit">标题</div>
            <span class="tilt"></span>
            <div class="echart_con" id="radar_echart"  style="height: 160px">
            </div>
        </div>
        <div class="modelpub margin10">
            <div class="common-tit">标题</div>
            <span class="tilt"></span>
            <div class="echart_con bar_l_echart" id="ldwhl"  style="height: 160px">
        ...
        <div class="modelpub ">
            <div class="common-tit">标题</div>
            <span class="tilt"></span>
            <div class="echart_con bar_c_echart"  id="sssjtj" style="height: 160px">
...
<!--首页底部 sta -->
<!--<div id="model-foot" class="model-foot"></div>-->
<!--首页底部 end-->
...
<script src="../../../../static/cockpit/js/common/header-footer2.js"></script>
<script src="../../../../static/cockpit/js/common/common.js"></script>
<script src="../../../../static/cockpit/js/common/unit.js"></script>
<script src="../../../../static/cockpit/js/pagejs/indexXCWX.js?c=2.9"></script>
