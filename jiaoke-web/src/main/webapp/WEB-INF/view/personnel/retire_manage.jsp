...
<div class="personnel-manage-style">
    <div class="top-statistics">
        <div class="top-statistics-style">
            <span>已经退休<h2 id="waitingLeave">0</h2>人</span>
        </div>
    </div>


    <div class="personnel-manage-content">
        <table class="simple-table simple-table-retire">
            <thead>
            <tr>
                <th>姓名</th>
                <th>性别</th>
    ...
    function parseResult(userInfos) {
        ...
        if (userInfoList.length === 0) {
            ...
            for (let i = 0; i < userInfoList.length; i++) {
                ...
                userInfo += '<td>' + userInfoList[i].idCard + '</td>';
                userInfo += '<td>' + userInfoList[i].phone + '</td>';
                userInfo += '<td>' + userInfoList[i].retirementDate + '</td>';
                userInfo += '<td>' + userInfoList[i].retirementCompany + '</td>';
                userInfo += '<td>' + userInfoList[i].physicalCondition + '</td>';
                userInfo += '<td>';
