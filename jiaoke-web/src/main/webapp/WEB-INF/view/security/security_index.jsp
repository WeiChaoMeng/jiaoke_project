...
<div class="right_page" style="width: 100%;height: 100%">
    <img src="../../../static/images/security/panorama2.jpg">

    <div id="office" style="position: absolute;left: 35%;top: 49%;font-size: 20px;background: #2196F3;width: 80px;height: 108px;opacity: .5;"></div>
    <div id="guard" style="position: absolute;left: 8%;top: 59%;font-size: 20px;background: #2196F3;width: 33px;height: 29px;opacity: .7;border-radius: 0 0 0 100px;"></div>
