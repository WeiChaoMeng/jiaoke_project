...
<html>
	...
	<body>
										...
										<div class="layui-form" style="width: 850px;margin: 0 auto;">
											<table class="layui-table">
												...
												<tbody>
													...
													<tr>
														<td>水洗后0.075mm筛下量m<span style="font-size: 1px;">0.075</span>(g)</td>
														<td id="sxh0075sxl_value1"></td>
														<td id="sxh0075sxl_value2"></td>
													</tr>
													<tr>
														<td>0.075mm通过率P<span style="font-size: 1px;">0.075</span>（%）</td>
														<td id="0075tgl_value1"></td>
														<td id="0075tgl_value2"></td>
														<td id="0075tgl_value_pj"></td>
													</tr>
												</tbody>
											</table>
											...
											<table class="layui-table">
												...
												<tbody>
													<tr>
														<td style="width: 118px;">干筛后总量Σm<span style="font-size: 0.3px;">i</span>(g)</td>
													...
													<tr>
														<td>扣除损耗后总量(g)</td>
														<td id="kcshlzl_value1"></td>
														<td></td>
														<td></td>
														<td></td>
														<td id="kcshlzl_value2"></td>
														<td></td>
														<td></td>
														<td></td>
														<td></td>
		...
		<script src="/static/js/qualitytest/experimental/qualitytestexperimental_cjl_sf_detail.js" charset="utf-8"></script>
