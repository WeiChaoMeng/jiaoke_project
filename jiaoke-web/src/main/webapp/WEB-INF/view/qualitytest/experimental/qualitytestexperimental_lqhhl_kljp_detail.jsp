...
<html>
	...
	<body>
										...
										<div class="layui-form" style="width: 850px;margin: 0 auto;">
											...
											<table class="layui-table">
												...
												<tr>
													...
													<tr>
														<td>损耗率(%)</td>
														<td id="shl_value1" style="width: 73px;"></td>
														<td style="width: 73px;"></td>
														<td style="width: 73px;"></td>
														<td style="width: 93px;"></td>
														<td id="shl_value2" style="width: 73px;"></td>
														<td style="width: 73px;"></td>
														<td style="width: 73px;"></td>
														<td style="width: 94px;"></td>
														<td style="width: 94px;"></td>
		...
		<script src="/static/js/qualitytest/experimental/qualitytestexperimental_lqhhl_kljp_detail.js" charset="utf-8"></script>
