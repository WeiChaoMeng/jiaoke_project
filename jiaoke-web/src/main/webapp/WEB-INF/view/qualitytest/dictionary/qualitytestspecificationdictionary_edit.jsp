...
<html>
	...
	<body>
		<form class="layui-form" id="myform" lay-filter="myform" style="padding:15px 15px;">
			<div class="layui-fluid" style="padding:10px 10px;">
				<div class="layui-card-body  innovation-form-width-ban">
					...
					<div class="layui-form-item">
						<label class="layui-form-label" style="white-space: pre-line;">规格名称<span style="color: red;">*</span></label>
						<div class="layui-input-block">
		...
		<script src="/static/js/qualitytest/dictionary/qualitytestspecificationdictionary_edit.js" charset="utf-8"></script>
