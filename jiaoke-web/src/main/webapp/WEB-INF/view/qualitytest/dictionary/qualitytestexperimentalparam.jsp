...
<html>
	...
	<body>
									...
									<div class="layui-inline">
										...
										<div class="layui-input-inline mr0">
											<select name="status" id="status" lay-filter="status" lay-verify="required" required>
												...
												<option value="0">未应用</option>
												<option value="1">应用中</option>
											</select>
										</div>
									</div>
									<div class="layui-inline">
	    ...
	    <a class="layui-btn layui-btn-normal layui-btn-sm" lay-event="btn_edit">配置试验</a>
		<a class="layui-btn layui-btn-sm " lay-event="btn_copy">复制</a>
		 
 {{# if(d.status==0){ }}
 <a class="layui-btn layui-btn-sm " lay-event="btn_use">应用</a>
    {{# } }}
 {{# if(d.status !=0){ }}
  <a class="layui-btn layui-btn-sm layui-btn-disabled" lay-event="btn_use">应用</a>
    {{# } }}
	
 {{# if(d.status == 1){ }}
 <a class="layui-btn layui-btn-sm " lay-event="btn_del">失效</a>
    {{# } }}
 {{# if(d.status !=1){ }}
  <a class="layui-btn layui-btn-sm layui-btn-disabled" lay-event="btn_del">失效</a>
    {{# } }}
</script>
		...
		<script src="/static/js/qualitytest/dictionary/qualitytestexperimentalparam.js" charset="utf-8"></script>
