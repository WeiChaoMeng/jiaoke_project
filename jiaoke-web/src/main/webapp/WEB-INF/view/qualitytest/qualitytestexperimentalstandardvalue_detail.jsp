...
<!-- 					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="experimentalId" id="experimental" lay-filter="experimental" lay-verify="required" required>
								<option value="">请选择</option>
							</select>
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">							
							<select name="experimentalItem" id="experimentalItem" lay-filter="" lay-verify="required" required>
								<option value="">请选择</option>
							</select>
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							...
							<input id="minValue" name="minValue" placeholder="" type="number" class="layui-input"
							  />
						</div>
					</div>
					<div class="layui-form-item" id="maxvalue_item">
						...
						<div class="layui-input-block">
							<div id="conferDept" class="xm-select-demo"></div>
							<input id="maxValue" name="maxValue" placeholder="0" type="number" class="layui-input"
							  />
						</div>
					</div>
