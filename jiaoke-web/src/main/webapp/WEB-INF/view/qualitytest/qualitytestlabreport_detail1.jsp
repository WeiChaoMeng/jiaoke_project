                        ...
                        <div style="border: 2px solid #c8cccf;">
                            <div class="layui-form-item layui-row" style="margin-top: 20px;">
                                ...
                                <div class="layui-col-xs12">
                                    ...
                                    <div class="layui-input-inline" style="width: 83%;">
                                        <input type="text" name="" lay-verify="title" autocomplete="off" disabled=true
                                               class="layui-input" value="北京市政路桥建材集团有限公司路驰分公司">
                                    </div>
                                </div>
                                <div class="layui-col-xs12">
                                ...
                                <div class="layui-col-xs6">
                                    ...
                                    <div class="layui-input-inline" style="width: 65%;">
                                        <input type="text" name="sampling_create_time" id="sampling_create_time"
                                               disabled=true lay-verify="date"
