...
<html>
	...
	<body>
										...
										<div class="layui-inline">
											...
											<div class="layui-input-inline mr0">
												<select name="status" id="status" lay-filter="status" lay-verify="required" required>
													<option value="">请选择</option>
													<option value="0">未添加试验</option>
													<option value="1">可补充试验</option>
		...
		<script type="text/html" id="tableBar">
			...
			{{# if(d.status ==0){ }}
	    <a class="layui-btn layui-btn-danger layui-btn-sm" lay-event="btn_add">添加试验</a>
		<a class="layui-btn layui-btn-danger layui-btn-sm layui-btn-disabled" lay-event="btn_confirm">完成试验</a>
	    {{# } }}
	   {{# if(d.status ==1){ }}
	    <a class="layui-btn layui-btn-danger layui-btn-sm" lay-event="btn_add">补充试验</a>
		<a class="layui-btn layui-btn-danger layui-btn-sm" lay-event="btn_confirm">完成试验</a>
	    {{# } }}
		{{# if(d.status == 2){ }}
		<a class="layui-btn layui-btn-danger layui-btn-sm layui-btn-disabled" lay-event="btn_add">添加试验</a>
		<a class="layui-btn layui-btn-danger layui-btn-sm layui-btn-disabled" lay-event="btn_confirm">完成试验</a>
		   {{# } }}
		...
		<script src="/static/js/qualitytest/qualitytestorderticket.js" charset="utf-8"></script>
