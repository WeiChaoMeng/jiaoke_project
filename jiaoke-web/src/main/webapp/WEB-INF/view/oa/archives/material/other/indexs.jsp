            ...
            <div class="layui-card">
                <div class="layui-card-body" style="min-height: 30px;">
                    ...
                    <div class="layui-input-inline layui-show-xs-block" style="float: right;">
                        <input type="text" id="name" placeholder="请输入文件名称" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    function searchButton(page, parameter) {
        ...
        $.ajax({
            type: "post",
            url: '/materialOther/searchFilter',
    ...
    //新建公司发文
    function add() {
        window.location.href = '${path}/materialOther/toAdd?page=' + $('#page').val();
    }

    //公司发文详情
    function particulars(id) {
        window.location.href = "${path}/materialOther/details?id=" + id + "&page=" + $('#page').val();
    }

    //修改
    function edit(id) {
        window.location.href = "${path}/materialOther/toEdit?id=" + id + "&page=" + $('#page').val();
    }

    //删除
    function remove(id) {
        window.top.deleteArchivesData('/materialOther', id, itselfFrameId);
    }

    //重载页面
    function reloadArchivesData(page) {
        window.location.href = "${path}/materialOther/toIndex?page=" + page;
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/materialOther/batchDelete", ids, itselfFrameId);
    }
