...
<script>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td class="text-too-long">' + resultList[i].certificate + '</td>';
                result += '<td class="text-too-long">' + resultList[i].issuingUnit + '</td>';
                result +=
    ...
    //删除
    function remove(id) {
        window.top.deleteArchivesData('/qualityPersonnel', id, itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/qualityPersonnel/batchDelete", ids, itselfFrameId);
    }
