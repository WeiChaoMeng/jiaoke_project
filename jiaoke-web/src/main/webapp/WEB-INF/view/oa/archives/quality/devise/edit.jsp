        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaQualityDevise.id}">
                    <input type="text" class="form-input" name="name" value="${oaQualityDevise.name}"
                           autocomplete="off">
                </td>

                <td class="table-td">版本日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="versionDateStr" value="${oaQualityDevise.versionDateStr}"
                           onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="remarks" value="${oaQualityDevise.remarks}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/qualityDevise/edit',
            data: $('#oaQualityDevise').serialize(),
