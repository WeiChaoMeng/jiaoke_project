        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaFinanceVoucher.id}">
                    <input type="text" class="form-input" name="number" value="${oaFinanceVoucher.number}"
                           autocomplete="off">
                </td>

                <td class="table-td">日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="dateStr" value="${oaFinanceVoucher.dateStr}"
                           onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="remarks" value="${oaFinanceVoucher.remarks}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/financeVoucher/edit',
            data: $('#oaFinanceVoucher').serialize(),
