            ...
            <td>
                <div>
                    <div class="conditional-query cursor_hand">
                        <input type="text" id="remarks" class="search-bar" placeholder="号段" autocomplete="off">
...
<table class="simple_table cursor_hand">
    ...
    <th style="width: 64%;">号段</th>
    <th style="width: 15%;">张数</th>
    <th style="width: 15%;">开票日期</th>
    </thead>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td style="text-align:left;text-indent:10px" title="' + resultList[i].numberSegment + '">' + resultList[i].numberSegment + '</td>';
