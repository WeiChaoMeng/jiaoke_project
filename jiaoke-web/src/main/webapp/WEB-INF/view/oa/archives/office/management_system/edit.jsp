    ...
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                ...
                <input type="text" name="fileName" id="fileName" value="${oaManagementSystem.fileName}"
                       autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="dateStr" class="forminput je-date" value="${oaManagementSystem.dateStr}"
                       readonly>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="remarks" value="${oaManagementSystem.remarks}" autocomplete="off">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function commitForm() {
        if ($.trim($("#fileName").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/managementSystem/edit',
                data: $('#oaManagementSystem').serialize(),
