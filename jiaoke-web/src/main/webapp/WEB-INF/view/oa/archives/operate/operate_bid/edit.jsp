        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="hidden" name="id" value="${oaOperateBid.id}">
                    <input type="text" class="form-input" name="tenderee" value="${oaOperateBid.tenderee}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="projectName" value="${oaOperateBid.projectName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="biddingUnit" value="${oaOperateBid.biddingUnit}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="proprietor" value="${oaOperateBid.proprietor}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="tenderPrice" value="${oaOperateBid.tenderPrice}"
                           autocomplete="off">
                </td>

                <td class="table-td">年度：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="yearStr" value="${oaOperateBid.yearStr}"
                           onfocus="this.blur()">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operateBid/edit',
            data: $('#oaOperateBid').serialize(),
