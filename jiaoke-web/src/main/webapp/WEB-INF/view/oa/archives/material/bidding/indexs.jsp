            ...
            <div class="layui-card">
                <div class="layui-card-body" style="min-height: 30px;">
                    ...
                    <div class="layui-input-inline layui-show-xs-block" style="float: right;">
                        <input type="text" id="file" placeholder="请输入招标文件" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form" lay-filter="demo">
                        ...
                        <tr>
                            ...
                            <th style="width: 33%">招标文件</th>
                            <th style="width: 20%">招标评分标准</th>
                            <th style="width: 20%">招标费</th>
...
<script>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td class="text-too-long">' + resultList[i].file + '</td>';
                result += '<td class="text-too-long">' + resultList[i].tenderingScore + '</td>';
                result += '<td class="text-too-long">' + resultList[i].biddingFee + '</td>';
                result +=
    ...
    //删除
    function remove(id) {
        window.top.deleteArchivesData('/materialBidding', id, itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/materialBidding/batchDelete", ids, itselfFrameId);
    }
