    ...
    <form id="oaProductionEquipment">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="fixedAssets" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="manufacturer" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="originalValue" autocomplete="off">
                </td>

                <td class="table-td">购入日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="buyDateStr" onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="material" autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/productionEquipment/add',
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/productionEquipment/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
