        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaOperateCustomer.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaOperateCustomer.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">客户名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="customerName" value="${oaOperateCustomer.customerName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="projectName" value="${oaOperateCustomer.projectName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="salesman" value="${oaOperateCustomer.salesman}"
                           autocomplete="off">
                </td>

                <td class="table-td">年度：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="yearStr" value="${oaOperateCustomer.yearStr}"
                           onfocus="this.blur()">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operateCustomer/edit',
            data: $('#oaOperateCustomer').serialize(),
