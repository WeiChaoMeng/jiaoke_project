    ...
    <form id="oaOperateMeeting">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="meetingDateStr" onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="theme" autocomplete="off">
                </td>
            </tr>
    ...
    function commit() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/operateMeeting/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
