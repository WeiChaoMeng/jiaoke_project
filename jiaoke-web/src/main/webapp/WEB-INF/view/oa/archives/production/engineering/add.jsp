        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="numbering" autocomplete="off">
                </td>

                <td class="table-td">工程名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="projectName" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="content" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="please" autocomplete="off">
                </td>

                <td class="table-td">批复文号：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="reply" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="contractNumber" autocomplete="off">
                </td>

                <td class="table-td">合同金额：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="contractAmount" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="settlementAmount" autocomplete="off">
                </td>

                <td class="table-td">竣工日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="completionDateStr" onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="storageLocation" autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/productionEngineering/add',
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/productionEngineering/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
