        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="hidden" name="id" value="${oaMaterialBidding.id}">
                    <input type="text" class="form-input" name="file" value="${oaMaterialBidding.file}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="issue" value="${oaMaterialBidding.issue}"
                           autocomplete="off">
                </td>

                <td class="table-td-width">投标登记表：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="registrationForm"
                           value="${oaMaterialBidding.registrationForm}" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="quote" value="${oaMaterialBidding.quote}"
                           autocomplete="off">
                </td>

                <td class="table-td-width">招标评分标准：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="tenderingScore"
                           value="${oaMaterialBidding.tenderingScore}" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="biddingFee" value="${oaMaterialBidding.biddingFee}"
                           autocomplete="off">
                </td>

                <td class="table-td-width">评分表：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="score" value="${oaMaterialBidding.score}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="scoreSummary" value="${oaMaterialBidding.scoreSummary}"
                           autocomplete="off">
                </td>

                <td class="table-td-width">招标评审意见表：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="reviewOpinion"
                           value="${oaMaterialBidding.reviewOpinion}" autocomplete="off">
