    ...
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="receiveDateStr" class="forminput je-date" readonly>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="documentReceivedNumber" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="documentName" id="documentName" autocomplete="off">
            </div>
        </div>
    ...
    function commitForm() {
        if ($.trim($("#documentNumber").val()) === '') {
            ...
            if ($.trim($("#documentName").val()) === '') {
                ...
                $.ajax({
                    type: "POST",
                    url: '${path}/receiveDocument/addReceiveDocument',
