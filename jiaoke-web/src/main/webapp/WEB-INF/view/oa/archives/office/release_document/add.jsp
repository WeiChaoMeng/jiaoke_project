...
<body>
<form action="${path}/releaseDocument/addReleaseDocument" name="oaReleaseDocument" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="visitDateStr" value="" class="forminput" id="datePicker" readonly="readonly"
                       required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="mainDeliveryDepartment" value="" required>
            </div>
        </div>
