...
<form id="oaReleaseDocument">
    ...
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="visitDateStr" class="je-date" readonly>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="mainDeliveryDepartment" autocomplete="off">
            </div>
        </div>
    ...
    function commitForm() {
        if ($.trim($("#documentNumber").val()) === '') {
            ...
            if ($.trim($("#documentName").val()) === '') {
                ...
                $.ajax({
                    type: "POST",
                    url: '${path}/releaseDocument/addReleaseDocument',
