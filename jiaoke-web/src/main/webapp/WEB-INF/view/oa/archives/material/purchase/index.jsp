            ...
            <td>
                <div>
                    <div class="conditional-query cursor_hand">
                        <input type="text" id="name" class="search-bar" placeholder="合同名称" autocomplete="off">
...
<table class="simple_table cursor_hand">
    ...
    <th style="width: 18%;">供货商名称</th>
    <th style="width: 18%;">材料名称</th>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td style="text-align:left;text-indent:10px" title="' + resultList[i].supplier + '">' + resultList[i].supplier + '</td>';
                result += '<td style="text-align:left;text-indent:10px" title="' + resultList[i].material + '">' + resultList[i].material + '</td>';
