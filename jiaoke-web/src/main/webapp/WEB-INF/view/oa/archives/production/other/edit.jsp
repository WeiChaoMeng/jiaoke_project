        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaProductionOther.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaProductionOther.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">文件名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="name" value="${oaProductionOther.name}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="summary" value="${oaProductionOther.summary}"
                           autocomplete="off">
                </td>

                <td class="table-td">发放日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="dateStr" value="${oaProductionOther.dateStr}"
                           onfocus="this.blur()">
...
<script type="text/javascript">
    ...
    function previousPage() {
        window.location.href = "${path}/productionOther/toIndex?page=" + currentPageNum;
    }
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/productionOther/edit',
            data: $('#oaProductionOther').serialize(),
