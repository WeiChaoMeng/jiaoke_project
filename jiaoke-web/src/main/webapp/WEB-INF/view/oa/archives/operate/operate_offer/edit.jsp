        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaOperateOffer.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaOperateOffer.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">客户名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="customerName" value="${oaOperateOffer.customerName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="projectName" value="${oaOperateOffer.projectName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="salesman" value="${oaOperateOffer.salesman}"
                           autocomplete="off">
                </td>

                <td class="table-td">报价日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="quoteDateStr" value="${oaOperateOffer.quoteDateStr}"
                           onfocus="this.blur()">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operateOffer/edit',
            data: $('#oaOperateOffer').serialize(),
