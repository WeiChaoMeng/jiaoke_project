...
<div class="table-container">
    <form id="oaFinanceBill">
        ...
        <table class="form-table">
            <tbody>
            <tr>
                <td class="table-td">开票日期：</td>
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaFinanceBill.id}">
                    <input type="text" class="form-input date_picker" name="invoiceDateStr" value="${oaFinanceBill.invoiceDateStr}"
                           onfocus="this.blur()">
                </td>

                <td class="table-td">数量：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="number" value="${oaFinanceBill.number}"
                           autocomplete="off">
                </td>
            </tr>

            <tr>
                <td class="table-td">号段：</td>
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="numberSegment" value="${oaFinanceBill.numberSegment}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function previousPage() {
        window.location.href = "${path}/financeBil/toIndex?page=" + currentPageNum;
    }
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/financeBil/edit',
            data: $('#oaFinanceBill').serialize(),
