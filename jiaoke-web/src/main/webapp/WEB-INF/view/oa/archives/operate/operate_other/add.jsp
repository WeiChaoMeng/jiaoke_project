    ...
    <form id="oaOperateOther">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="fileName" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="summary" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="issueLeader" autocomplete="off">
                </td>

                <td class="table-td">发放日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="releaseDateStr" onfocus="this.blur()">
    ...
    function commit() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/operateOther/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
