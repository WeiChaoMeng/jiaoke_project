            ...
            <td>
                <div>
                    <div class="conditional-query cursor_hand">
                        <input type="text" id="deviceName" class="search-bar" placeholder="设备名称" autocomplete="off">
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td>' + resultList[i].name + '</td>';
                result += '<td>' + resultList[i].type + '</td>';
                result += '<td>' + resultList[i].manufacturer + '</td>';
