    ...
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="dateStr" class="je-date" value="${oaContractAgreement.dateStr}" readonly>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="hidden" name="id" value="${oaContractAgreement.id}">
                <input type="text" name="contractLabel" value="${oaContractAgreement.contractLabel}" id="contractLabel" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="contractAgreementName" value="${oaContractAgreement.contractAgreementName}" id="contractAgreementName" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="type" value="${oaContractAgreement.type}" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="years" value="${oaContractAgreement.years}" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="remarks" value="${oaContractAgreement.remarks}" autocomplete="off">
            </div>
        </div>
    ...
    function commitForm() {
        if ($.trim($("#contractLabel").val()) === '') {
            ...
            if ($.trim($("#contractAgreementName").val()) === '') {
                ...
                $.ajax({
                    type: "POST",
                    url: '${path}/contractAgreement/edit',
