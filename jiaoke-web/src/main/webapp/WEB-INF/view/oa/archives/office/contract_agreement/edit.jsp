...
<body>
<form action="${path}/contractAgreement/edit" name="oaContractAgreement" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="dateStr" value="${oaContractAgreement.dateStr}" class="forminput"
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                ...
                <input type="text" name="contractLabel" value="${oaContractAgreement.contractLabel}" required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="contractAgreementName" value="${oaContractAgreement.contractAgreementName}" required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="type" value="${oaContractAgreement.type}"
                       required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="years" value="${oaContractAgreement.years}" required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="remarks" value="${oaContractAgreement.remarks}" required>
            </div>
        </div>
