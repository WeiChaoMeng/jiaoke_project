        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaProductionEnergy.id}">
                    <input type="text" class="form-input date_picker" name="yearStr"
                           value="${oaProductionEnergy.yearStr}" onfocus="this.blur()">
                </td>

                <td class="table-td-special">产量(吨)：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="yield" value="${oaProductionEnergy.yield}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="outputValue" value="${oaProductionEnergy.outputValue}"
                           autocomplete="off">
                </td>

                <td class="table-td-special">万元产值能耗(吨标准煤/万元)：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="productionConsume"
                           value="${oaProductionEnergy.productionConsume}" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="productConsume"
                           value="${oaProductionEnergy.productConsume}" autocomplete="off">
                </td>

                <td class="table-td-special">天然气消耗量(万立方米)：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="gasConsume" value="${oaProductionEnergy.gasConsume}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="powerConsumption"
                           value="${oaProductionEnergy.powerConsumption}" autocomplete="off">
                </td>

                <td class="table-td-special">单位产品碳排放量(千克二氧化碳/吨)：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="carbonEmission"
                           value="${oaProductionEnergy.carbonEmission}" autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/productionEnergy/edit',
