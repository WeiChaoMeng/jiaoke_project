            ...
            <td>
                <div>
                    <div class="conditional-query cursor_hand">
                        <input type="text" id="theme" class="search-bar" placeholder="会议主题" autocomplete="off">
...
<script>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td style="text-align:left;text-indent:10px" title="' + resultList[i].theme + '">' + resultList[i].theme + '</td>';
    ...
    //重载页面
    function operateMeetingPageReload(page) {
    ...
    function del() {
        ...
        if (length !== 1) {
            ...
            var id = $("tbody input:checked").val();
            //主页fun
            window.top.deleteOperateMeeting(id, $('#page').val());
        }
    }
