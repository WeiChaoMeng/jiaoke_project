        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaMaterialOther.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaMaterialOther.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">文件名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="name" value="${oaMaterialOther.name}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="summary" value="${oaMaterialOther.summary}"
                           autocomplete="off">
                </td>

                <td class="table-td">发放日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="dateStr" value="${oaMaterialOther.dateStr}"
                           onfocus="this.blur()">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/materialOther/edit',
            data: $('#oaMaterialOther').serialize(),
