        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaOperateDevelop.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaOperateDevelop.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">购买方：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="purchaser" value="${oaOperateDevelop.purchaser}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="signingDateStr"
                           value="${oaOperateDevelop.signingDateStr}" onfocus="this.blur()">
                </td>

                <td class="table-td">业务员：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="salesman" value="${oaOperateDevelop.salesman}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="amount" value="${oaOperateDevelop.amount}"
                           autocomplete="off">
                </td>

                <td class="table-td">结清日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="settlementDateStr"
                           value="${oaOperateDevelop.settlementDateStr}" onfocus="this.blur()">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operate/edit',
            data: $('#oaOperateDevelop').serialize(),
