        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaOperateMeeting.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaOperateMeeting.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">会议日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="meetingDateStr"
                           value="${oaOperateMeeting.meetingDateStr}"
                           onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="theme" value="${oaOperateMeeting.theme}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="summary" value="${oaOperateMeeting.summary}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operateMeeting/edit',
            data: $('#oaOperateMeeting').serialize(),
