        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaFinanceConfirm.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaFinanceConfirm.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">确认：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="confirm" value="${oaFinanceConfirm.confirm}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="amount" value="${oaFinanceConfirm.amount}"
                           autocomplete="off">
                </td>

                <td class="table-td">客户名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="name" value="${oaFinanceConfirm.name}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/financeConfirm/edit',
            data: $('#oaFinanceConfirm').serialize(),
