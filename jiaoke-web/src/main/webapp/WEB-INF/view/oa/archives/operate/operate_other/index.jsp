...
<script>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td style="text-align:left;text-indent:10px" title="' + resultList[i].fileName + '">' + resultList[i].fileName + '</td>';
    ...
    //重载页面
    function operateOtherPageReload(page) {
    ...
    function del() {
        ...
        if (length !== 1) {
            ...
            var id = $("tbody input:checked").val();
            //主页fun
            window.top.deleteOperateOther(id, $('#page').val());
        }
    }
