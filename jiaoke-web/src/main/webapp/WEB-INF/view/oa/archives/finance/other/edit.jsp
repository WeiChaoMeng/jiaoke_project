        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaFinanceOther.id}">
                    <input type="text" class="form-input" name="name" value="${oaFinanceOther.name}"
                           autocomplete="off">
                </td>

                <td class="table-td">发放日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="releaseDateStr" value="${oaFinanceOther.releaseDateStr}"
                           onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="summary" value="${oaFinanceOther.summary}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/financeOther/edit',
            data: $('#oaFinanceOther').serialize(),
