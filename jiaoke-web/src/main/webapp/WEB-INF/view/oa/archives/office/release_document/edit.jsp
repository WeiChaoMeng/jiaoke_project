...
<body>
<form action="${path}/releaseDocument/edit" name="oaReleaseDocument" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                ...
                <input type="text" name="documentNumber" value="${oaReleaseDocument.documentNumber}" required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="documentName" value="${oaReleaseDocument.documentName}" required>
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="visitDateStr" value="${oaReleaseDocument.visitDateStr}" class="forminput"
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="remarks" value="${oaReleaseDocument.remarks}" required>
            </div>
        </div>
