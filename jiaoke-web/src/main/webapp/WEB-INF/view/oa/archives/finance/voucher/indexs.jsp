...
<script>
    ...
    function loadData(page) {
        $.ajax({
            type: "post",
            url: '/financeVoucher/loadingData',
            data: {'page': page},
            async: false,
    ...
    function searchButton(page, parameter) {
        ...
        $.ajax({
            type: "post",
            url: '/financeVoucher/searchFilter',
    ...
    //新建公司发文
    function add() {
        window.location.href = '${path}/financeVoucher/toAdd?page=' + $('#page').val();
    }

    //公司发文详情
    function particulars(id) {
        window.location.href = "${path}/financeVoucher/details?id=" + id + "&page=" + $('#page').val();
    }

    //修改
    function edit(id) {
        window.location.href = "${path}/financeVoucher/toEdit?id=" + id + "&page=" + $('#page').val();
    }

    //删除
    function remove(id) {
        window.top.deleteArchivesData('/financeVoucher', id, itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/financeVoucher/batchDelete", ids, itselfFrameId);
    }
