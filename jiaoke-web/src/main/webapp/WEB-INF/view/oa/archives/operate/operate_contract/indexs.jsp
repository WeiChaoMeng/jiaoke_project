                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form" lay-filter="demo">
                        ...
                        <tr>
                            ...
                            <th style="width: 14%">合同编号</th>
                            <th style="width: 19%">购买方</th>
...
<script>
    ...
    //删除
    function remove(id) {
        window.top.deleteArchivesData('/operate', id, itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/operate/batchDelete", ids, itselfFrameId);
    }
