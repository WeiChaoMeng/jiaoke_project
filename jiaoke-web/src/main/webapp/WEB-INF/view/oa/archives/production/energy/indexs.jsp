            ...
            <div class="layui-card">
                <div class="layui-card-body" style="min-height: 30px;">
                    ...
                    <div class="layui-input-inline layui-show-xs-block" style="float: right;">
                        <input type="text" id="yearStr" placeholder="请输入年份" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form" lay-filter="demo">
                        ...
                        <tr>
                            ...
                            <th style="width: 8%">产量(吨)</th>
                            <th style="width: 8%">产值(万元)</th>
                            <th style="width: 24%">单位产品能耗(千克标准煤/吨)</th>
                            <th style="width: 25%">单位产品碳排放量(千克二氧化碳/吨)</th>
...
<script>
    ...
    //删除
    function remove(id) {
        window.top.deleteArchivesData('/productionEnergy', id, itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/productionEnergy/batchDelete", ids, itselfFrameId);
    }
