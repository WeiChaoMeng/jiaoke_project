    ...
    <form id="oaQualityDevise">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="versionDateStr" onfocus="this.blur()">
                </td>
            </tr>
    ...
    function commit() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/qualityDevise/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
