            ...
            <td>
                <div>
                    <div class="conditional-query cursor_hand">
                        <input type="text" id="projectName" class="search-bar" placeholder="工程名称" autocomplete="off">
...
<table class="simple_table cursor_hand">
    ...
    <th style="width: 20%;">招标单位</th>
    <th style="width: 20%;">工程名称</th>
    <th style="width: 20%;">竞标单位</th>
    <th style="width: 10%;">投标价格</th>
    <th style="width: 14%;">业主</th>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td style="text-align:left;text-indent:10px">' + resultList[i].tenderee + '</td>';
                result += '<td style="text-align:left;text-indent:10px" title="' + resultList[i].projectName + '">' + resultList[i].projectName + '</td>';
                result += '<td>' + resultList[i].biddingUnit + '</td>';
                result += '<td>' + resultList[i].tenderPrice + '</td>';
                result += '<td>' + resultList[i].proprietor + '</td>';
