            ...
            <div class="layui-card">
                <div class="layui-card-body" style="min-height: 30px;">
                    ...
                    <div class="layui-input-inline layui-show-xs-block" style="float: right;">
                        <input type="text" id="remarks" placeholder="请输入备注" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    function parseResult(resultLists) {
        ...
        if (resultList.length === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td class="text-too-long">' + resultList[i].remarks + '</td>';
    ...
    //删除
    function remove(id) {
        window.top.deleteArchivesData('/financeMaterial', id, itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/financeMaterial/batchDelete", ids, itselfFrameId);
    }
