        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaProductionEquipment.id}">
                    <input type="text" class="form-input date_picker" name="yearStr"
                           value="${oaProductionEquipment.yearStr}" onfocus="this.blur()">
                </td>

                <td class="table-td">固定资产编号：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="fixedAssets" value="${oaProductionEquipment.fixedAssets}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="name" value="${oaProductionEquipment.name}"
                           autocomplete="off">
                </td>

                <td class="table-td">设备型号：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="type" value="${oaProductionEquipment.type}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="manufacturer" value="${oaProductionEquipment.manufacturer}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="originalValue"
                           value="${oaProductionEquipment.originalValue}" autocomplete="off">
                </td>

                <td class="table-td">购入日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="buyDateStr"
                           value="${oaProductionEquipment.buyDateStr}" onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="storageLocation"
                           value="${oaProductionEquipment.storageLocation}" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="material" value="${oaProductionEquipment.material}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/productionEquipment/edit',
            data: $('#oaProductionEquipment').serialize(),
