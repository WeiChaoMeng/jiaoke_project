        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaOperateSign.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaOperateSign.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">签认日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="signingDateStr"
                           value="${oaOperateSign.signingDateStr}" onfocus="this.blur()">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="purchaser" value="${oaOperateSign.purchaser}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="salesman" value="${oaOperateSign.salesman}"
                           autocomplete="off">
                </td>

                <td class="table-td">签认金额：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="amount" value="${oaOperateSign.amount}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operateSign/edit',
            data: $('#oaOperateSign').serialize(),
