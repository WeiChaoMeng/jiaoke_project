    ...
    <form id="oaOperateDevelop">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="purchaser" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="signingDateStr" onfocus="this.blur()">
                </td>

                <td class="table-td">业务员：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="salesman" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="amount" autocomplete="off">
                </td>

                <td class="table-td">结清日期：</td>
                <td class="table-content">
                    <input type="text" class="form-input date_picker" name="settlementDateStr" onfocus="this.blur()">
    ...
    function commit() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/operate/toOperateContract?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
