    ...
    <form id="oaOperateLawsuit">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="lawsuitAmount" autocomplete="off">
                </td>

                <td class="table-td">状态：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="state" autocomplete="off">
    ...
    function commit() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/operateLawsuit/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
