        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="hidden" name="id" value="${oaOperateLawsuit.id}">
                    <input type="text" class="form-input" name="numbering" value="${oaOperateLawsuit.numbering}"
                           autocomplete="off">
                </td>

                <td class="table-td">客户名称：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="customerName" value="${oaOperateLawsuit.customerName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="projectName" value="${oaOperateLawsuit.projectName}"
                           autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="lawsuitAmount" value="${oaOperateLawsuit.lawsuitAmount}"
                           autocomplete="off">
                </td>

                <td class="table-td">状态：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="state" value="${oaOperateLawsuit.state}"
                           autocomplete="off">
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/operateLawsuit/edit',
            data: $('#oaOperateLawsuit').serialize(),
