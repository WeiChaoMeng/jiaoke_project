    ...
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                ...
                <input type="text" name="reportNumber" value="${oaEiaMonitor.reportNumber}" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="sampleName" id="sampleName" value="${oaEiaMonitor.sampleName}"
                       autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="testingCompany" value="${oaEiaMonitor.testingCompany}" autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="testingDateStr" class="je-date" value="${oaEiaMonitor.testingDateStr}" readonly>
            </div>
        </div>
