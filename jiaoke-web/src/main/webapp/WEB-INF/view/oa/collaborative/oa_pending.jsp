                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form" lay-filter="demo">
                        ...
                        <tr>
                            ...
                            <th style="width: 10%">上一个处理人</th>
                            <th style="width: 10%">状态</th>
                            <th style="width: 14%">发起时间</th>
                            <th style="width: 14%">接收时间</th>
...
<script>
    ...
    function loadData(page) {
        ...
        $.ajax({
            type: "post",
            url: '/collaboration/loadingPendingData',
        ...
        if (resultLists === 'noData' || resultLists.total === 0) {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result +=
                    ...
                    '<button class="layui-btn layui-btn layui-btn-xs" onclick="particulars(\'' + resultList[i].url + '\',\'' + resultList[i].correlationId + '\',\'' + resultList[i].taskId + '\')"><i class="layui-icon">&#xe642;</i>审批</button>\n' +
                    '</td>';
                result += '</tr>';
            }
        }
