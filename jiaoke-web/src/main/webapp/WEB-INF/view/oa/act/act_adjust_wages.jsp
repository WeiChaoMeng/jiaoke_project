...
<form id="oaActAdjustWages">
                ...
                <td style="width: 35%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="调资申请表(${nickname} <%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>)"
                               autocomplete="off">
                    </div>
                </td>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="currentSalary" autocomplete="off">
            </td>

            <td class="tdLabel">期望薪资</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="salaryExpectation" autocomplete="off">
            </td>
        </tr>
...
<script>
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/adjustWages/savePending',
                data: $('#oaActAdjustWages').serialize(),
                error: function (request) {
                    layer.msg("出错！");
                },
