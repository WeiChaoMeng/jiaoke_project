            ...
            <tr>
                ...
                <td style="width: 44%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题" value="${oaActIntegrity.title}" autocomplete="off">
                    </div>
                </td>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput entry-date" name="dateStr" value="${oaActIntegrity.dateStr}" onfocus="this.blur()">
                <input type="hidden" id="annex" name="annex">
                <input type="hidden" id="id" name="id" value="${oaActIntegrity.id}">
            </td>

            <td class="tdLabel">地点</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="address" value="${oaActIntegrity.address}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="talker" value="${oaActIntegrity.talker}" readonly>
            </td>

            <td class="tdLabel">被谈话人</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="interviewee" value="${oaActIntegrity.interviewee}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation" style="padding: 10px;height: 110px;">
                <textarea class="evaluation-content" style="height: 100%" name="content">${oaActIntegrity.content}</textarea>
            </td>
        </tr>
...
<script>
    ...
    function send() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/integrity/editAdd',
                data: $('#oaActIntegrity').serialize(),
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${path}/integrity/deleteAnnexes',
