        ...
        <tr>
            ...
            <td colspan="5" class="approval-content">
                ...
                <div style="width: 49%;float: right">
                    ...
                    <shiro:lacksPermission name="principal">
                    <textarea class="approval-content-textarea"
                              readonly>${oaActOfficeSupplies.principalContentT}</textarea>
                        <div class="approval-date">
                            <label class="approval-date-label">日期 </label>
                        ...
                        <div class="approval-signature">
                            <label class="approval-signature-label">签字 </label>
                            <input class="approval-signature-input" type="text" value="${oaActOfficeSupplies.principalT}"
                                   readonly>
                        </div>
                    </shiro:lacksPermission>
                </div>
...
<script>
    ...
    if (officeSupplies.state === 0) {
        ...
        if (flag === 0) {
            if (officeSupplies.principalT === "" || officeSupplies.principalT === undefined) {
                $('#principalContentT').append(
                    '<div id="officeSuppliesReview"><textarea class="write-approval-content-textarea" onkeyup="value=value.replace(/\\s+/g,\'\')" name="principalContentT"></textarea>\n' +
                    '<div class="approval-date"><label class="approval-date-label">日期 </label>\n' +
                    '<input class="approval-date-input" type="text" name="principalDateT" value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>" readonly>\n' +
                    '</div><div class="approval-signature"><label class="approval-signature-label">签字 </label>\n' +
                    '<input class="approval-signature-input" type="text" name="principalT" value="${nickname}" readonly></div></div>');
                flag = 1;
            } else {
                $('#principalContentT').append(
                    '<textarea class="approval-content-textarea" readonly>${oaActOfficeSupplies.principalContentT}</textarea>\n' +
                    '<div class="approval-date"><label class="approval-date-label">日期 </label>\n' +
                    '<input class="approval-date-input" type="text" value="${oaActOfficeSupplies.principalDateT}" readonly>\n' +
                    '</div><div class="approval-signature"><label class="approval-signature-label">签字 </label>\n' +
                    '<input class="approval-signature-input" type="text" value="${oaActOfficeSupplies.principalT}" readonly></div>');
            }
        } else {
            $('#principalContentT').append(
                '<textarea class="approval-content-textarea" readonly>${oaActOfficeSupplies.principalContentT}</textarea>\n' +
