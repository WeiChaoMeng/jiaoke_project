        ...
        <tr>
            ...
            <td colspan="5" class="approval-content">
                ...
                <div style="width: 49%;float: right;">
                    ...
                    <shiro:lacksPermission name="principal">
                    <textarea class="approval-content-textarea"
                              readonly>${oaActLaborContractRenewal.principalContentT}</textarea>
                        <div class="approval-date">
                            <label class="approval-date-label">日期 </label>
                            <input class="approval-date-input" type="text"
                                   value="${oaActLaborContractRenewal.principalDateT}" readonly>
                        </div>
                        <div class="approval-signature">
                            <label class="approval-signature-label">签字</label>
                            <input class="approval-signature-input" type="text"
                                   value="${oaActLaborContractRenewal.principalT}" readonly>
                        </div>
                    </shiro:lacksPermission>
                </div>
            </td>
...
<script>
    ...
    if (laborContractRenewal.state === 0) {
        ...
        if (flag === 0) {
            if (laborContractRenewal.principalT === "" || laborContractRenewal.principalT === undefined) {
                ...
                $('#principalContentT').append('<textarea class="approval-content-textarea" readonly>${oaActLaborContractRenewal.principalContentT}</textarea>' +
                    '<div class="approval-date"><label class="approval-date-label">日期 </label>' +
                    '<input class="approval-date-input" type="text" value="${oaActLaborContractRenewal.principalDateT}" readonly></div>' +
                    '<div class="approval-signature"><label class="approval-signature-label">签字 </label>' +
                    '<input class="approval-signature-input" type="text" value="${oaActLaborContractRenewal.principalT}" readonly></div>');
            }
        } else {
            $('#principalContentT').append('<textarea class="approval-content-textarea" readonly>${oaActLaborContractRenewal.principalContentT}</textarea>' +
                '<div class="approval-date"><label class="approval-date-label">日期 </label>' +
