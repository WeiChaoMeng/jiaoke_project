    ...
    <div class="form_area" id="titleArea" style="margin-bottom: 15px">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="common_input_frame">
                        <input type="text" placeholder="人事(查阅)→发起者部门负责人→发起者部门主管领导→人事部门主管领导→总经理→发起人、人事(知会)" readonly>
                    </div>
                </td>
            </tr>
            </tbody>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="5" class="approval-content">
                <textarea class="approval-content-textarea" style="height: 90px;background-color: #fff;" oninput="value=value.replace(/\s+/g,'')"
