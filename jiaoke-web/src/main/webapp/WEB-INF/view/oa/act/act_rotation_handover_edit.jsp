...
<form id="oaActRotationHandover">
            ...
            <tr>
                ...
                <td style="width: 44%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题" value="${oaActRotationHandover.title}" autocomplete="off">
                    </div>
                </td>
    ...
    <span class="fill-in-date">填表日期：</span>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="departure" value="${oaActRotationHandover.departure}" readonly>
                <input type="hidden" id="annex" name="annex">
                <input type="hidden" id="id" name="id" value="${oaActRotationHandover.id}">
            </td>

            <td class="tdLabel">接岗人姓名</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="receive" value="${oaActRotationHandover.receive}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="departureBefore" value="${oaActRotationHandover.departureBefore}" autocomplete="off">
            </td>

            <td class="tdLabel">接岗前岗位</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="receiveBefore" value="${oaActRotationHandover.receiveBefore}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="departureAfter" value="${oaActRotationHandover.departureAfter}" autocomplete="off">
            </td>

            <td class="tdLabel">接岗后岗位</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="receiveAfter" value="${oaActRotationHandover.receiveAfter}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation" style="padding: 10px;height: 200px;">
                <textarea class="evaluation-content" style="height: 100%" name="matter">${oaActRotationHandover.matter}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation" style="padding: 10px;height: 94px;">
                <textarea class="evaluation-content" style="height: 100%" name="problem">${oaActRotationHandover.problem}</textarea>
            </td>
        </tr>
...
<script>
    ...
    function send() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/rotationHandover/editAdd',
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/rotationHandover/edit',
                data: $('#oaActRotationHandover').serialize(),
                error: function (request) {
                    layer.msg("出错！");
                },
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${path}/rotationHandover/deleteAnnexes',
