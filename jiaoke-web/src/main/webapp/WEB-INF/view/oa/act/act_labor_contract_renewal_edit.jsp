...
<form id="oaActLaborContractRenewal">
    <div class="form_area" id="titleArea" style="margin-bottom: 15px">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="common_input_frame">
                        <input type="text" placeholder="发起者部门负责人(审批)、发起者部门主管领导(审批)、组织人事部门(审批)、总经理(审批)、发起者(协同)" readonly>
                    </div>
                </td>
            </tr>
            </tbody>
    ...
    <div>
        <div class="notice-content">
            <input type="text" class="notice-personnel-field" name="name" value="${oaActLaborContractRenewal.name}" autocomplete="off">与我公司签订的劳动合同将于
            <input class="agreement-start-end start-date" type="text" name="startDateStr" value="${oaActLaborContractRenewal.startDateStr}" onfocus="this.blur()">到期，请各部门（领导）于
            <input class="agreement-start-end end-date" type="text" name="endDateStr" value="${oaActLaborContractRenewal.endDateStr}" onfocus="this.blur()">前签署意见。
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${path}/laborContractRenewal/deleteAnnexes',
