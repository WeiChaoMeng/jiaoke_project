...
<form id="oaActLaborContractStop">
    ...
    <div>
        <div class="notice-personnel">
            <input type="text" class="notice-personnel-field" onclick="recipientSelect()" name="notifiedPerson" id="recipientName" readonly>:
        ...
        <div class="notice-content">
            ...
            <input class="agreement-start-end end-date" type="text" name="endDate" onfocus="this.blur()">的劳动合同将于
            <input type="text" class="agreement-days" name="number" autocomplete="off"
...
<script>
    ...
    function send() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/laborContractStop/add',
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/laborContractStop/savePending',
                data: $('#oaActLaborContractStop').serialize(),
                error: function (request) {
                    layer.msg("出错！");
                },
