    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-content" style="padding: 10px">
                <textarea oninput="value=value.replace(/\s+/g,'')" class="write-approval-content-textarea" name="faultDescription" style="width: 100%">${oaActMaintain.faultDescription}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-content" style="padding: 10px">
                <textarea oninput="value=value.replace(/\s+/g,'')" class="write-approval-content-textarea" name="content" style="width: 100%">${oaActMaintain.content}</textarea>
            </td>
        </tr>
