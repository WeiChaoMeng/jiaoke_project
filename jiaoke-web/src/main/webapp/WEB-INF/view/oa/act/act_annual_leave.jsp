...
<form id="oaActAnnualLeave">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="total" oninput="value=value.replace(/^0(0+)|[^\d]/g,'')"
                       autocomplete="off">
            </td>

            <td class="tdLabel">计划休假时间</td>
            <td class="table-td-content">
                <input type="text" class="formInput apply-date" name="planDate" onfocus="this.blur()">
            </td>
        </tr>
