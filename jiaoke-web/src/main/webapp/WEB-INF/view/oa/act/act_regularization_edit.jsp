...
<form id="oaActRegularization">
    ...
    <span class="fill-in-date">填表日期：${oaActRegularization.createTimeStr}</span>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="name" value="${oaActRegularization.name}"
                       readonly>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="position" value="${oaActRegularization.position}"
                       autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput entry-date" name="entryDateStr"
                       value="${oaActRegularization.entryDateStr}" onfocus="this.blur()">
            </td>

            <td class="tdLabel">试用期时间</td>
            <td class="table-td-content">
                <input type="text" class="formInput probation-date" name="probationPeriodStr"
                       value="${oaActRegularization.probationPeriodStr}" onfocus="this.blur()">
            </td>
        </tr>
