        ...
        <tr>
            ...
            <td colspan="5" class="table-td-textarea" style="line-height: 0">
                ...
                <div class="opinion-supervisor" style="width: 32%;float: left;margin: 0 3px;">
                    ...
                    <shiro:lacksPermission name="principal">
                        <textarea class="opinion-column-Juxtaposition"
                                  readonly>${oaActRelieveLaborContract.principalContentT}</textarea>
                        <div class="approval-date">
                            <label class="approval-date-label">日期 </label>
                            <input class="approval-date-input" type="text"
                                   value="${oaActRelieveLaborContract.principalDateT}"
                                   readonly>
                        </div>
                        <div class="approval-signature">
                            <label class="approval-signature-label">签字 </label>
                            <input class="approval-signature-input" type="text"
                                   value="${oaActRelieveLaborContract.principalT}" readonly>
                        </div>
                    </shiro:lacksPermission>
                </div>
                ...
                <div class="opinion-supervisor" style="width: 34%;float: right;">
                    ...
                    <shiro:hasPermission name="supervisor">
                        <div style="width: 100%;" id="supervisorContent"></div>
                    </shiro:hasPermission>
...
<script>
    ...
    if (relieveLaborContract.personnelCensor === "" || relieveLaborContract.personnelCensor === undefined) {
        ...
        if (relieveLaborContract.state === 0) {
            ...
            if (flag === 0) {
                if (relieveLaborContract.principalT === "" || relieveLaborContract.principalT === undefined) {
                    ...
                    $('#principalContentT').append('<textarea class="approval-content-textarea" readonly>${oaActRelieveLaborContract.principalContentT}</textarea>' +
                        '<div class="approval-date"><label class="approval-date-label">日期 </label>' +
                        '<input class="approval-date-input" type="text" value="${oaActRelieveLaborContract.principalDateT}" readonly></div>' +
                        '<div class="approval-signature"><label class="approval-signature-label">签字 </label>' +
                        '<input class="approval-signature-input" type="text" value="${oaActRelieveLaborContract.principalT}" readonly></div>');
                }
            } else {
                $('#principalContentT').append('<textarea class="approval-content-textarea" readonly>${oaActRelieveLaborContract.principalContentT}</textarea>' +
                    '<div class="approval-date"><label class="approval-date-label">日期 </label>' +
