...
<form id="oaActRegularization">
    <div class="form_area" id="titleArea" style="margin-bottom: 15px">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="common_input_frame">
                        <input type="text" placeholder="人事(查阅)→发起者部门负责人→发起者部门主管领导→人事部门→总经理→发起人、人事(知会)"
                               readonly="readonly">
                    </div>
                </td>
            </tr>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput probation-date" name="probationPeriod" onfocus="this.blur()">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation">
                <textarea oninput="value=value.replace(/\s+/g,'')" class="evaluation-content"
                          name="selfAssessment"></textarea>
