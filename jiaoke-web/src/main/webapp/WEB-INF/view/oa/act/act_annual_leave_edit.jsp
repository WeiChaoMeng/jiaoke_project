...
<form id="oaActAnnualLeave">
    ...
    <span class="fill-in-date">填表日期：${oaActAnnualLeave.createTimeStr}</span>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="department" value="${oaActAnnualLeave.department}"
                       readonly>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput apply-date" name="planDateStr"
                       value="${oaActAnnualLeave.planDateStr}" onfocus="this.blur()">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput actual-date" name="actualDateStr"
                       value="${oaActAnnualLeave.actualDateStr}" onfocus="this.blur()">
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${path}/annualLeave/deleteAnnexes',
