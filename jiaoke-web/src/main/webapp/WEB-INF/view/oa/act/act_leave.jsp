    ...
    <div class="form_area" id="titleArea" style="margin-bottom: 15px">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="common_input_frame">
                        <input type="text" placeholder="发起者部门负责人→发起者部门主管领导→发起人、人事(知会)"
                               readonly="readonly">
                    </div>
                </td>
            </tr>
    ...
    <table class="formTable" style="margin: 0">
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation">
                <textarea class="evaluation-content" oninput="value=value.replace(/\s+/g,'')" style="height: 58px"
