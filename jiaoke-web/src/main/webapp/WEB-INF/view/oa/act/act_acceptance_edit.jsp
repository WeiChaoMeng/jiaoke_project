    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content" style="padding: 10px">
                <textarea class="opinion-column" name="content" style="width: 100%">${oaActAcceptance.content}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput je-date" name="acceptanceDateStr" value="${oaActAcceptance.acceptanceDateStr}" onfocus="this.blur()">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="accepter" value="${oaActAcceptance.accepter}" autocomplete="off">
            </td>

            <td class="tdLabel">经办人：</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="operator" value="${oaActAcceptance.operator}" readonly="readonly">
            </td>
        </tr>
        </tbody>
