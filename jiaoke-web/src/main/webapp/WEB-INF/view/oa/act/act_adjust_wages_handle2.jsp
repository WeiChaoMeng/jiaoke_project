                ...
                <div class="opinion-principal" style="width: 32%;float: left;margin: 0 3px">
                    ...
                    <shiro:lacksPermission name="principal">
                        ...
                        <div class="approval-signature">
                            <label class="approval-signature-label">签字 </label>
                            <input class="approval-signature-input" type="text"
                                   value="${oaActAdjustWages.principalT}" readonly>
                        </div>
                    </shiro:lacksPermission>
                </div>
...
<script>
    ...
    if (adjustWages.personnelCensor === "" || adjustWages.personnelCensor === undefined) {
        ...
        if (adjustWages.state === 0) {
            ...
            if (flag === 0) {
                if (adjustWages.principalT === "" || adjustWages.principalT === undefined) {
                    ...
                    $('#principalContentT').append('<textarea class="approval-content-textarea" readonly>${oaActAdjustWages.principalContentT}</textarea>' +
                        '<div class="approval-date"><label class="approval-date-label">日期 </label>' +
                        '<input class="approval-date-input" type="text" value="${oaActAdjustWages.principalDateT}" readonly></div>' +
                        '<div class="approval-signature"><label class="approval-signature-label">签字 </label>' +
                        '<input class="approval-signature-input" type="text" value="${oaActAdjustWages.principalT}" readonly></div>');
                }
            } else {
                $('#principalContentT').append('<textarea class="approval-content-textarea" readonly>${oaActAdjustWages.principalContentT}</textarea>' +
                    '<div class="approval-date"><label class="approval-date-label">日期 </label>' +
