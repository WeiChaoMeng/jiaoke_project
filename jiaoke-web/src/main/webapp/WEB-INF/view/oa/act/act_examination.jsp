...
<form id="oaActExamination">
                ...
                <td style="width: 31%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="职称（技术等级）考试申请表(${nickname} <%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>)"
                               autocomplete="off">
                    </div>
                </td>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="techLevel" autocomplete="off">
            </td>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="positionLevel" autocomplete="off">
            </td>

            <td class="tdLabel">申请人签字</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="applicantSignature" autocomplete="off">
            </td>
        </tr>
...
<script>
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/examination/savePending',
                data: $('#oaActExamination').serialize(),
                error: function (request) {
                    layer.msg("出错！");
                },
