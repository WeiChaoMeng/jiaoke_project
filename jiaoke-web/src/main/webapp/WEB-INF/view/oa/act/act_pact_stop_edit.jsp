                ...
                <td style="width: 40%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="${oaActPactStop.title}" autocomplete="off">
                    </div>
                </td>
    ...
    <div>
        <div class="notice-personnel">
            <input type="text" class="notice-personnel-field" onclick="recipientSelect()"
                   value="${oaActPactStop.notifiedPerson}" name="notifiedPerson" id="recipientName" readonly>:
            <input type="hidden" id="recipientId" name="notifiedPersonId" value="${oaActPactStop.notifiedPersonId}">
        </div>

        <div class="notice-content">
            你与我公司签订的协议期为
            <input class="agreement-start-end start-date" type="text" name="startDate"
                   value="${oaActPactStop.startDate}" onfocus="this.blur()">至
            <input class="agreement-start-end end-date" type="text" name="endDate" value="${oaActPactStop.endDate}"
                   onfocus="this.blur()">的劳务协议将于
            <input type="text" class="agreement-days" name="number" value="${oaActPactStop.number}"
