                ...
                <td style="width: 44%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="${oaActUnitPrice.title}" autocomplete="off">
                    </div>
                </td>
        ...
        <tr id="creditRating">
            <td class="table-td-content" colspan="3">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        一级客户<input type="checkbox" class="checked-box-style" name="creditRating" value="0">
                    </c:otherwise>
                </c:choose>
        ...
        <tr id="unitNature">
            <td class="table-td-content" colspan="3">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        内部单位<input type="checkbox" class="checked-box-style" name="unitNature" value="0">
                    </c:otherwise>
                </c:choose>

                <c:choose>
                    <c:when test="${oaActUnitPrice.unitNature == 1}">
                        外部单位<input type="checkbox" checked class="checked-box-style" name="unitNature" value="1">
                    </c:when>
                    <c:otherwise>
        ...
        <tr id="paymentMethod">
            <td class="table-td-content" colspan="3">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        预付全款<input type="checkbox" class="checked-box-style" name="paymentMethod" value="0">
                    </c:otherwise>
                </c:choose>

                <c:choose>
                    <c:when test="${oaActUnitPrice.paymentMethod == 1}">
                        当年支付全款<input type="checkbox" checked class="checked-box-style" name="paymentMethod" value="1">
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${oaActUnitPrice.paymentMethod == 2}">
                        当年支付80%及以上<input type="checkbox" checked class="checked-box-style" name="paymentMethod" value="2">
                    </c:when>
                    <c:otherwise>
        ...
        <tr id="number">
            <td class="table-td-content" colspan="3">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        50000吨以上<input type="checkbox" class="checked-box-style" name="number" value="0">
                    </c:otherwise>
                </c:choose>

                <c:choose>
                    <c:when test="${oaActUnitPrice.number == 1}">
                        10000吨-50000吨<input type="checkbox" checked class="checked-box-style" name="number" value="1">
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${oaActUnitPrice.number == 2}">
                        5000吨-10000吨<input type="checkbox" checked class="checked-box-style" name="number" value="2">
                    </c:when>
                    <c:otherwise>
