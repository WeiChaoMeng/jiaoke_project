...
<form id="oaActEmployment">
                ...
                <td style="width: 26%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="部室用人申请表(${nickname} <%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>)"
                               autocomplete="off">
                    </div>
                </td>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="job" autocomplete="off">
            </td>

            <td class="tdLabel">人数</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="peopleNumber" autocomplete="off">
            </td>
        </tr>
...
<script>
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/employment/savePending',
                data: $('#oaActEmployment').serialize(),
                error: function (request) {
                    layer.msg("出错！");
                },
