    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-content" style="padding: 10px">
                <textarea class="write-approval-content-textarea" name="faultDescription" style="width: 100%"></textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-content" style="padding: 10px">
                <textarea class="write-approval-content-textarea" name="content" style="width: 100%"></textarea>
            </td>
        </tr>
