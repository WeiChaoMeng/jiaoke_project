...
<div class="table-title">
    <span>${transferTwo.title}</span>
</div>

<div class="top_toolbar" id="tool">
    <div class="top-toolbar-details">
        <div class="top-info-bar-user">
            <span>${transferTwo.promoterStr}</span>
        </div>

        <div class="top-info-bar-time">
            <span>${transferTwo.createTimeStr}</span>
        </div>
        ...
        <c:when test="${transferTwo.annex != ''}">
            <div class="top_toolbar" id="annexList">
                <div class="top-annexes-details">
                    ...
                    <c:forTokens items="${transferTwo.annex}" delims="," var="annex">
    ...
    <tr>
        ...
        <td colspan="5" class="table-td-evaluation">
            <textarea class="evaluation-content-disabled" style="height: 90px" name="cause"
                      disabled>${transferTwo.cause}</textarea>
