...
<form id="oaActContractReview">
                ...
                <td style="width: 26%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="合同评审表(${nickname} <%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>)"
                               autocomplete="off">
                    </div>
                </td>
    ...
    <span class="fill-in-date">合同编号<input type="text" name="contractNumber" class="form-number-content" autocomplete="off"></span>
    ...
    <table class="formTable" style="margin: 0;">
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput" name="contractName" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput" name="customerName" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput" name="engineeringName" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput" name="modelNumber" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput entry-date" name="feedingTime" onfocus="this.blur()">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput" name="settlementTerms" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="table-td-content">
                <input type="text" class="formInput" name="contractPrice" autocomplete="off">
            </td>
        </tr>
    ...
    <div>
        <span class="fill-in-date" style="float: left;margin: 5px 0 20px 10px;">
            利润中心：<input type="text" name="profitCenter" class="form-number-content" autocomplete="off">
        </span>
        <span class="fill-in-date" style="margin: 5px 10px 20px 0;">
            制表人：<input type="text" class="form-number-content" style="cursor: not-allowed;" value="${nickname}" readonly>
        </span>
    </div>
</form>
...
<script>
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/contractReview/savePending',
                data: $('#oaActContractReview').serialize(),
                error: function (request) {
                    window.top.tips("出错！", 6, 2, 1000);
                },
