...
<head>
    <meta charset="utf-8">
    <title>劳务派遣员工协议签订、续订、变更、终止审批表</title>
...
<div class="table-title">
    <span>外包人员协议签订、续订、变更、终止审批表</span>
</div>
...
<form id="oaActPactSign">
                ...
                <td style="width: 39%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="外包人员协议签订、续订、变更、终止审批表(${nickname} <%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>)"
                               autocomplete="off">
                    </div>
                </td>
    ...
    <div>
        <div class="notice-content">
            <input type="text" class="notice-personnel-field" onclick="recipientSelect()" id="recipientName" readonly>与外包公司签订的劳务协议将于
