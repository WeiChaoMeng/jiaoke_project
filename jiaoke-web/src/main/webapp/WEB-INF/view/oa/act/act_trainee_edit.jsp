...
<form id="oaActTrainee">
    <div class="form_area" id="titleArea" style="margin-bottom: 15px">
        <table>
            ...
            <tr>
                ...
                <td style="width: 35%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="${oaActTrainee.title}" autocomplete="off">
                    </div>
                </td>
                ...
                <td>
                    <div class="common_input_frame">
                        <input type="text" placeholder="人事(查阅)→总经理→发起人、人事(知会)" readonl>
                    </div>
                </td>
            </tr>
            </tbody>
    ...
    <input type="text" style="float: left;width: 200px;" class="filling-date-content" name="corporation" value="${oaActTrainee.corporation}" readonly>
    ...
    <table class="formTable" style="margin: 0">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="name" value="${oaActTrainee.name}" readonly>
                <input type="hidden" name="id" id="id" value="${oaActTrainee.id}">
                <input type="hidden" name="promoter" id="promoter" value="${oaActTrainee.promoter}">
            </td>

            <td class="tdLabel">性别</td>
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="sex" value="${oaActTrainee.sex}" readonly>
            </td>

            <td class="tdLabel">出生年月</td>
            <td class="table-td-content">
                <input type="text" class="formInput entry-date" name="birthday" value="${oaActTrainee.birthday}" onfocus="this.blur()">
            </td>

            <td class="tdLabel">参加工作时间</td>
            <td class="table-td-content">
                <input type="text" class="formInput certificate-date" name="workingHours" value="${oaActTrainee.workingHours}" onfocus="this.blur()">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="education" value="${oaActTrainee.education}" autocomplete="off">
            </td>

            <td class="tdLabel">何时毕业于何校</td>
            <td class="table-td-content" colspan="3">
                <input type="text" class="formInput" name="school" value="${oaActTrainee.school}" autocomplete="off">
            </td>

            <td class="tdLabel">学制</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="schoolSystem" value="${oaActTrainee.schoolSystem}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="7" class="approval-content" style="padding: 10px;">
                <textarea class="write-approval-content-textarea" name="resume" style="height: 100%;">${oaActTrainee.resume}</textarea>
            </td>
        </tr>

        <tr>
            <td class="tdLabel" colspan="8" style="padding: 0;text-align: center;">大中专院校毕业见习期：从
                <input type="text" class="formInput graduation-date" style="width: 10%" name="internship" value="${oaActTrainee.internship}" onfocus="this.blur()">
                见习期工资<input type="text" class="formInput" style="width: 10%" name="wages" value="${oaActTrainee.wages}" autocomplete="off">元/月</td>
        </tr>

        <tr>
            <td class="tdLabel" style="width: 5%;text-align: center;padding: 15px 0;line-height: normal;">自<br/>我<br/>鉴<br/>定</td>
            <td colspan="7" class="approval-content" style="padding: 10px;">
                <textarea class="write-approval-content-textarea" style="height: 100%;" name="selfAccreditation">${oaActTrainee.selfAccreditation}</textarea>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="formTable" style="margin: 0">
        ...
        <tr>
            ...
            <td class="table-td-content" colspan="6" style="padding: 10px;">
                <textarea class="write-approval-content-textarea" name="remarks">${oaActTrainee.remarks}</textarea>
