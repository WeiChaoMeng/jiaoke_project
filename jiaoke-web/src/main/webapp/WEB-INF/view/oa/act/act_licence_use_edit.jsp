...
<form id="oaActLicenceUse">
                ...
                <td style="width: 44%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="${oaActLicenceUse.title}" autocomplete="off">
                    </div>
                </td>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content" style="width: 100%">
                <select class="select" name="seal">
                    <c:choose>
                        <c:when test="${oaActLicenceUse.seal == 0}">
                    ...
                    <c:choose>
                        <c:when test="${oaActLicenceUse.seal == 1}">
                    ...
                    <c:choose>
                        <c:when test="${oaActLicenceUse.seal == 2}">
                    ...
                    <c:choose>
                        <c:when test="${oaActLicenceUse.seal == 3}">
                    ...
                    <c:choose>
                        <c:when test="${oaActLicenceUse.seal == 4}">
        ...
        <tr>
            ...
            <td class="table-td-content">
                ...
                <input type="text" class="formInput je-date" name="receiveTimeStr" value="${oaActLicenceUse.receiveTimeStr}" onfocus="this.blur()">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="purpose" value="${oaActLicenceUse.purpose}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="user" value="${oaActLicenceUse.user}" readonly="readonly">
            </td>
        </tr>
        </tbody>
...
<script>
    ...
    function send() {
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/licenceUse/editAdd',
                data: $('#oaActLicenceUse').serialize(),
