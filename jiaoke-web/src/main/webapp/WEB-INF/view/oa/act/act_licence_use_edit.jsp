    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content" colspan="3" style="padding: 10px">
                <textarea class="write-approval-content-textarea" oninput="value=value.replace(/\s+/g,'')" name="purpose">${oaActLicenceUse.purpose}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content" style="width: 340px;">
                <input type="text" class="formInput-readonly" name="user" value="${oaActLicenceUse.user}" readonly="readonly">
            </td>
