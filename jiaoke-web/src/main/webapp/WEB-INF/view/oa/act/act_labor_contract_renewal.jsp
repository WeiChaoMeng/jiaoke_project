...
<form id="oaActLaborContractRenewal">
    ...
    <div>
        <div class="notice-content">
            <input type="text" class="notice-personnel-field" name="name" autocomplete="off">与我公司签订的劳动合同将于
            <input class="agreement-start-end start-date" type="text" name="startDateStr" onfocus="this.blur()">到期，请各部门（领导）于
            <input class="agreement-start-end end-date" type="text" name="endDateStr" onfocus="this.blur()">前签署意见。
