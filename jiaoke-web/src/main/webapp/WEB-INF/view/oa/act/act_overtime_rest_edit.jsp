...
<form id="oaActOvertimeRest">
    ...
    <span class="fill-in-date">填表日期：${oaActOvertimeRest.createTimeStr}</span>
    ...
    <table class="formTable" style="margin: 0">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="name" value="${oaActOvertimeRest.name}" readonly>
                <input type="hidden" id="id" name="id" value="${oaActOvertimeRest.id}">
            </td>

            <td class="tdLabel">申请时间</td>
            <td class="table-td-content">
                <input type="text" class="formInput entry-date" name="applyDateStr" value="${oaActOvertimeRest.applyDateStr}" onfocus="this.blur()">
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation">
                <textarea class="evaluation-content" style="height: 90px"  name="reason">${oaActOvertimeRest.reason}</textarea>
...
<script>
    ...
    function send() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/overtimeRest/editAdd',
                data: $('#oaActOvertimeRest').serialize(),
