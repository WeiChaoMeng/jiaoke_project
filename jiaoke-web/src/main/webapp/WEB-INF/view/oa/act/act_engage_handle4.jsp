        ...
        <tr>
            <td colspan="2" class="table-td-textarea" style="line-height: 0">
                ...
                <div class="opinion-principal" style="width: 49%;float: right">
                    <textarea class="opinion-column-Juxtaposition" readonly>${oaActExamination.principalContentT}</textarea>
                    <div class="approval-date">
                        <label class="approval-date-label">日期 </label>
                        <input class="approval-date-input" type="text" value="${oaActExamination.principalDateT}" readonly>
                    </div>
                    <div class="approval-signature">
                        <label class="approval-signature-label">签字 </label>
