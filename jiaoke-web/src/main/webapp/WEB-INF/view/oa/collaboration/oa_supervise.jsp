        ...
        <tr>
            <td>
                <div class="head_left_button">
                    <button type="button" class="cursor_hand" onclick="rescind()">&#xe891;撤销流程</button>
                </div>
            ...
            <td>
                <div>
                    <div class="conditional-query cursor_hand">
                        <input type="text" id="purchaser" class="search-bar" placeholder="标题" autocomplete="off">
    ...
    function parseResult(resultLists) {
        ...
        if (resultLists === 'noData') {
            ...
            for (let i = 0; i < resultList.length; i++) {
                ...
                result += '<td><input type="checkbox" value="' + resultList[i].url + ',' + resultList[i].id + ',' + resultList[i].processInstanceId + ',' + resultList[i].correlationId + '" onclick="window.event.cancelBubble=true;"></td>';
