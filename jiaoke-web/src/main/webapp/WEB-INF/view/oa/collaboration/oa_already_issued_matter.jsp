...
<div class="list_page_height">
        ...
        <table width="100%" height="100%">
            ...
            <tr>
                <td>
                    ...
                    <div class="head_left_button head_left_button_width" onmousemove="select_color(this)"
    ...
    <table class="simpletable">
        ...
        <tr>
            ...
            <td>无</td>
            <td>全部人员</td>
            <td style="text-align: center"><i class="iconfont" onclick="journal(this)">&#xe64c;</i></td>
        </tr>
