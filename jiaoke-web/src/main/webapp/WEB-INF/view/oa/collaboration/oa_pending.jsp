    ...
    function parseResult(resultLists) {
        ...
        if (resultLists === 'noData') {
            ...
            for (let i = 0; i < resultList.length; i++) {
                result += '<tr onclick="particulars(\'' + resultList[i].url + '\',\'' + resultList[i].correlationId + '\',\'' + resultList[i].taskId + '\')">';
                result += '<td><input type="checkbox" value="' + resultList[i].correlationId + '" onclick="window.event.cancelBubble=true;"></td>';
