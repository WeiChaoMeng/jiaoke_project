...
<script>
    ...
    function searchButton(page, parameter) {
        ...
        $.ajax({
            type: "post",
            url: '/mainDelivery/mainDeliveryFilter',
    ...
    function addMainDelivery() {
        window.top.addMainDelivery("/mainDelivery", $('#page').val(), itselfFrameId);
    }

    //重载页面
    function parameterConfigurationPage(page) {
        window.location.href = "${path}/mainDelivery/toIndex?page=" + page;
    }

    //编辑
    function editMainDelivery(id, name, description) {
        window.top.editMainDelivery(id, name, description, "/mainDelivery", $('#page').val(), itselfFrameId);
    }
    ...
    function binding(id) {
        $.ajax({
            type: "post",
            url: '/mainDelivery/toBinding',
            data: {'id': id},
            dataType: 'json',
            success: function (data) {
                //主页fun
                window.top.bindingMainDelivery(data, id,"/mainDelivery", $('#page').val(), itselfFrameId);
            },
            error: function (result) {
                layer.msg("出错！");
            }
    ...
    function deleteMainDelivery(id) {
        window.top.deleteMainDelivery(id, "/mainDelivery", itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/mainDelivery/batchDeleteMain", ids, itselfFrameId);
    }
