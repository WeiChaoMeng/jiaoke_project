...
<div class="">
    ...
    <div class="content_title">
        ...
        <table class="simpletable simpletable_color" style="width: 1510px">

            <thead>
            <th style="width: 50px"><input type="checkbox"></th>
            <th style="width: 500px ">标题</th>
            <th style="width: 190px">公文文号</th>
            <th style="width: 90px">发起人</th>
            <th style="width: 160px ">发起时间</th>
            <th style="width: 160px">接收时间</th>
            <th style="width: 90px ">处理期限</th>
            <th style="width: 90px ">催办次数</th>
            <th style="width: 90px">处理状态</th>
            <th style="width: 90px ">流程日志</th>
