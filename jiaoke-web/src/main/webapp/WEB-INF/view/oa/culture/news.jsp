            ...
            <div class="layui-card">
                <div class="layui-card-body" style="min-height: 30px">
                    ...
                    <shiro:hasPermission name="news:add">
                        <button class="layui-btn" onclick="addNews()">
...
<script>
    ...
    function parseResult(userInfos) {
        ...
        if (userInfoList.length === 0) {
            ...
            for (let i = 0; i < userInfoList.length; i++) {
                ...
                userInfo += '<td title="' + userInfoList[i].newsHeadlines + '">' + userInfoList[i].newsHeadlines + '</td>';
                ...
                userInfo += '<td title="' + userInfoList[i].summary + '">' + userInfoList[i].summary + '</td>';
                userInfo +=
    ...
    //删除
    function del(id) {
        window.top.cultureCorporateDelete('/newsCenter', id, $('#page').val(),itselfFrameId);
    }

    //重载页面
    function reloadCultureCorporateData(page) {
        window.location.href = '${path}/newsCenter/toNewsList?page=' + page;
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/newsCenter/batchDeleteNews", ids, itselfFrameId);
    }
