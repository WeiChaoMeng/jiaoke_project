            ...
            <div class="layui-card">
                <div class="layui-card-body" style="min-height: 30px">
                    ...
                    <shiro:hasPermission name="notice:add">
                        <button class="layui-btn" onclick="addNotice()">
...
<script>
    ...
    function parseResult(userInfos) {
        ...
        if (userInfoList.length === 0) {
            ...
            for (let i = 0; i < userInfoList.length; i++) {
                ...
                userInfo += '<td title="' + userInfoList[i].title + '">' + userInfoList[i].title + '</td>';
    ...
    //删除用户
    function del(id) {
        window.top.cultureCorporateDelete('/notice', id, $('#page').val(), itselfFrameId);
    }
    ...
    function delAll() {
        ...
        window.top.batchDeleteData("/notice/batchDeleteNotice", ids, itselfFrameId);
    }
