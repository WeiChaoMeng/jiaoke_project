    ...
    function loadData(page) {
        $.ajax({
            ...
            success: function (data) {
                var oaCorporateHonors = JSON.parse(data);
                //总数
                $("#PageCount").val(oaCorporateHonors.total);
                //每页显示条数
                $("#PageSize").val("15");
                //结果集
                var oaCorporateHonorList = oaCorporateHonors.list;
                //当前页
                var pageNum = oaCorporateHonors.pageNum;
                //插入tbody
                var oaCorporateHonor = '';
                if (oaCorporateHonorList.length === 0) {
                    oaCorporateHonor += '<tr>';
                    oaCorporateHonor += '<td colspan="7">' + '暂无数据' + '</td>';
                    oaCorporateHonor += '</tr>';
                } else {
