...
<div style="width:100%;margin: 20px auto;text-align: center">
    <span style="font-size: 17px;">客饭审批表</span>
</div>
...
<form id="oaDocumentProcessing" action="" method="post">
    ...
    <table class="formtable">
        ...
        <tr>
            ...
            <td>
                <select class="select" name="state" data-value="0" required>
                    ...
                    <option value="4">40元</option>
                    <option value="5">50元</option>
                    <option value="6">60元</option>
                </select>
            </td>
        </tr>

        <tr>
            <td class="tlabel">招待事由：</td>
        ...
        <tr>
            <td class="tlabel">桌数：</td>
            <td>
                <input type="text" class="forminput" value="" autocomplete="off">
            </td>

            <td class="tlabel">人数：</td>
            <td>
                <input type="text" class="forminput" value="" autocomplete="off">
            </td>

            <td class="tlabel">地点：</td>
            <td>
                <input type="text" class="forminput" value="" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            <td class="tlabel">厨师选择：</td>
            <td>
                <select class="select" name="state" data-value="0" required>
                    <option value="0">请选择</option>
                    <option value="1">大厨</option>
                    <option value="2">二厨</option>
                </select>
            </td>

            <td class="tlabel">菜类：</td>
            <td>
                <select class="select" name="state" data-value="0" required>
                    <option value="0">请选择</option>
