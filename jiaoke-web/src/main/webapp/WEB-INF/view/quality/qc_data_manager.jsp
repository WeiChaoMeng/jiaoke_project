                ...
                <div class="layui-card">
                    <div class="layui-card-body ">
                        ...
                        <table class="layui-table layui-form" lay-filter="demo">
                            <thead>
                            <tr>
                                <th style="width: 10%">产品日期</th>
                                <th style="width: 10%">产量<i>T/吨</i></th>
                            ...
                            <tr>
                                ...
                                <td class="td-manage">
                                    <button class="layui-btn layui-btn layui-btn-xs"  onclick='location.href="${path}/getProducttionByDate.do?producedDate=${item.produceDate}&crewNum=${item.crewNum}"' ><i class="layui-icon">&#xe63c;</i>详情</button>
                                </td>
                            </tr>
                            </c:forEach>
                        </table>
