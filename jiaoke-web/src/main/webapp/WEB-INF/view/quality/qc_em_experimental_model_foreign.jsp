...
<form  class="bootstrap-frm">
    ...
    <label>
        <span>样品规格 :</span>
        <input type="text" class="doubleInput" name="sampling_standard" value ="机制砂" />
        <span>取样日期 :</span>
        <input type="text" class="doubleInput" name="sampling_date" value ="Valid Email Address" />
    </label>
    ...
    <label>
        ...
        <span>实验日期 :</span>
        <input type="text" class="simplInput" name="test_date" value ="Valid Email Address" />
    </label>
...
<script type="text/javascript" src="/static/js/qc/experimental_model_foreign.js"></script>
