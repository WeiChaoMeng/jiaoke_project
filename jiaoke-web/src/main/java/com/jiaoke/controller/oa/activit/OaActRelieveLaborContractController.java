...
public class OaActRelieveLaborContractController {
    ...
    public String approvalApi(String id, String taskId) {
        ...
        String departmentId = userInfoService.selectDepartmentByUserId(oaActRelieveLaborContract.getPromoter());
        if ("single".equals(oaActRelieveLaborContract.getDepartmentPrincipal())){
        ...
        }else if (oaActRelieveLaborContract.getDepartmentPrincipal().contains(",")){
            String[] split = oaActRelieveLaborContract.getDepartmentPrincipal().split(",");
            ...
            principal = userInfoService.getNicknameById(Integer.valueOf(oaActRelieveLaborContract.getDepartmentPrincipal()));
        }
        ...
        map.put("relieveLaborContract", oaActRelieveLaborContract);
