...
public class OaActLaborContractRenewalController {
    ...
    public String toEdit(String id, Model model) {
        OaActLaborContractRenewal oaActLaborContractRenewal = oaActLaborContractRenewalService.selectByPrimaryKey(id);
        model.addAttribute("oaActLaborContractRenewal", oaActLaborContractRenewal);
        model.addAttribute("annexList", JsonHelper.toJSONString(oaActLaborContractRenewal.getAnnex()));
    ...
    public String editAdd(OaActLaborContractRenewal oaActLaborContractRenewal) {
        ...
        if (oaActLaborContractRenewalService.edit(oaActLaborContractRenewal) < 0) {
            ...
            String instance = activitiUtil.startProcessInstanceByKey("oa_meals", "oa_act_meals:" + oaActLaborContractRenewal.getId(), map, getCurrentUser().getId().toString());
            if (instance != null) {
                //发送成功后更新状态
    ...
    public String deleteAnnexes(String[] array, String id) {
        if (oaActLaborContractRenewalService.updateAnnexes(array, id) < 1) {
            return "error";
        }
        return "success";
    }
