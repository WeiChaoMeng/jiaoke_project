...
public class OaActRotationController {
    ...
    public String approval(String id, String taskId, Model model) {
        //审批
        OaActRotation oaActMeals = oaActRotationService.selectByPrimaryKey(id);
        //获取批注信息
    ...
    public String toEdit(String id, Model model) {
        ...
        model.addAttribute("annexList", JsonHelper.toJSONString(oaActRotation.getAnnex()));
    ...
    public String editAdd(OaActRotation oaActRotation) {
        ...
        if (oaActRotationService.edit(oaActRotation) < 0) {
            ...
            String instance = activitiUtil.startProcessInstanceByKey("oa_meals", "oa_act_meals:" + oaActRotation.getId(), map, getCurrentUser().getId().toString());
            if (instance != null) {
                //发送成功后更新状态
    ...
    public String deleteAnnexes(String[] array, String id) {
        if (oaActRotationService.updateAnnexes(array, id) < 1) {
            return "error";
        }
        return "success";
    }
