...
public class OaActTransferController {
    ...
    public String toEdit(String id, Model model) {
        ...
        model.addAttribute("annexList", JsonHelper.toJSONString(oaActTransfer.getAnnex()));
    ...
    public String editAdd(OaActTransfer oaActTransfer) {
        ...
        if (oaActTransferService.edit(oaActTransfer) < 0) {
            ...
            String instance = activitiUtil.startProcessInstanceByKey("oa_meals", "oa_act_meals:" + oaActTransfer.getId(), map, getCurrentUser().getId().toString());
            if (instance != null) {
                //发送成功后更新状态
    ...
    public String deleteAnnexes(String[] array, String id) {
        if (oaActTransferService.updateAnnexes(array, id) < 1) {
            return "error";
        }
        return "success";
    }
