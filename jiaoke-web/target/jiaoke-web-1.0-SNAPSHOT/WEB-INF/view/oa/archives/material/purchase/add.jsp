    ...
    <form id="oaMaterialPurchase">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="supplier" autocomplete="off">
                </td>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="unitPrice" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="remarks" autocomplete="off">
                </td>
    ...
    function commit() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/materialPurchase/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
