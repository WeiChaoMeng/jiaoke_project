    ...
    <form id="oaProductionEnvironment">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="constructionUnit" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" class="table-content">
                    <input type="text" class="form-input" name="controlMeasures" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="number" autocomplete="off">
                </td>

                <td class="table-td">型号：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="type" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="retrofitCost" autocomplete="off">
                </td>

                <td class="table-td">对应合同编号：</td>
                <td class="table-content">
                    <input type="text" class="form-input" name="correspondingContract" autocomplete="off">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-content">
                    <input type="text" class="form-input" name="contaminants" autocomplete="off">
                </td>
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        $.ajax({
            type: "POST",
            url: '${path}/productionEnvironment/add',
            ...
            success: function (result) {
                if (result === "success") {
                    layer.msg("成功");
                    window.location.href = "${path}/productionEnvironment/toIndex?page=1";
                } else {
                    layer.msg('失败');
                    $("#editorHTNL").val('');
                }
