...
<body>
<form action="${path}/managementSystem/add" name="oaManagementSystem" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="fileName" value="" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="remarks" value="" required autocomplete="off">
            </div>
        </div>
