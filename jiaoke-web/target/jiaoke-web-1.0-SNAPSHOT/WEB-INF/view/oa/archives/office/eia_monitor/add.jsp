...
<body>
<form action="${path}/eiaMonitor/add" name="oaEiaMonitor" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="reportNumber" value="" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="sampleName" value="" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="testingCompany" value="" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="testingDateStr" value="" class="forminput" id="datePicker" readonly="readonly"
                       required>
            </div>
        </div>
