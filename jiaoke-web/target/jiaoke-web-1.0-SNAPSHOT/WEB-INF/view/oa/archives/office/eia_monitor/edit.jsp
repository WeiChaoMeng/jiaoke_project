...
<body>
<form action="${path}/eiaMonitor/edit" name="oaEiaMonitor" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="hidden" name="id" value="${oaEiaMonitor.id}">
                <input type="text" name="reportNumber" value="${oaEiaMonitor.reportNumber}" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="sampleName" value="${oaEiaMonitor.sampleName}" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="testingCompany" value="${oaEiaMonitor.testingCompany}" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="testingDateStr" value="${oaEiaMonitor.testingDateStr}" class="forminput"
