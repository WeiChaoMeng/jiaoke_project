...
<body>
<form action="${path}/managementSystem/edit" name="oaManagementSystem" method="post">
    <!-- 表单内容 -->
    <div class="contract-new-page">
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="hidden" name="id" value="${oaManagementSystem.id}">
                <input type="text" name="fileName" value="${oaManagementSystem.fileName}" required autocomplete="off">
            </div>
        </div>
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="dateStr" value="${oaManagementSystem.dateStr}" class="forminput"
        ...
        <div class="contract-form">
            ...
            <div class="contract-form-input">
                <input type="text" name="remarks" value="${oaManagementSystem.remarks}" required autocomplete="off">
            </div>
        </div>
