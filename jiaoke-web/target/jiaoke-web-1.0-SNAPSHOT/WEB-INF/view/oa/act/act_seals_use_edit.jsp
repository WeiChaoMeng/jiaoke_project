    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                ...
                <input type="text" class="formInput" name="number" value="${oaActSealsUse.number}" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="applicant" value="${oaActSealsUse.applicant}"
                       readonly="readonly">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput" name="name" value="${oaActSealsUse.name}" autocomplete="off">
            </td>
        </tr>
        </tbody>
    </table>
