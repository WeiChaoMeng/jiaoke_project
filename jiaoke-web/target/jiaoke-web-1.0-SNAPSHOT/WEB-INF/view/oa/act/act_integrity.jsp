                ...
                <td style="width: 44%">
                    <div class="common_input_frame">
                        <input type="text" id="title" name="title" placeholder="请输入标题" title="点击此处填写标题"
                               value="廉政谈话审批表(${nickname} <%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>)"
                               autocomplete="off">
                    </div>
                </td>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput entry-date" name="dateStr" onfocus="this.blur()">
                <input type="hidden" id="annex" name="annex">
            </td>

            <td class="tdLabel">地点</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="address" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <input type="text" class="formInput-readonly" name="talker" value="${nickname}" readonly>
            </td>

            <td class="tdLabel">被谈话人</td>
            <td class="table-td-content">
                <input type="text" class="formInput" name="interviewee" autocomplete="off">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" class="table-td-evaluation" style="padding: 10px;height: 110px;">
                <textarea class="evaluation-content" style="height: 100%" name="content"></textarea>
            </td>
        </tr>
...
<script>
    ...
    function savePending() {
        ...
        if ($.trim($("#title").val()) === '') {
            ...
            $.ajax({
                type: "POST",
                url: '${path}/integrity/savePending',
                data: $('#oaActIntegrity').serialize(),
                error: function (request) {
                    layer.msg("出错！");
                },
