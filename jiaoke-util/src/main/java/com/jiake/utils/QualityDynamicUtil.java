...
//                asphalt_ratio = (asphalt_content/(100 - asphalt_content)) * 100;
    ...
    public static String returnJsonData(List<Map<String,String>> list, QualityDynamicDao qualityDynamicDao, String ratioName, String material, String crew, HttpServletRequest request,String date){
...
//                asphalt_ratio = (asphalt_content/(100 - asphalt_content)) * 100;
        ...
        res.put("ratioMap",ratioMap);
        res.put("rationList",ratios);
        res.put("allItem",content);
        res.put("maxMin",maxMin);
        res.put("svg3",svg3);
        res.put("moudelRatio",moudelRatio);
        res.put("svg5up",svg5up);
        res.put("svg5down",svg5down);
        res.put("maxMinUp",maxMinUp);
        res.put("contentY",contentY);
        res.put("maxMinY",maxMinY);
        res.put("svg3Y",svg3Y);
        res.put("discNumMap",discNumMap);
