...
/**
 * quality_test_specification_dictionary实体类
 * 
 * @author 
 *
 */
public class QualityTestSpecificationDictionary extends QualityTestPage {
	/***/
	@JSONField(name="Id")
	private Integer id; 
	/***/
	 ...
	 * 实例化
	 */
	public QualityTestSpecificationDictionary() {
		super();
	}
	/**
	 * 实例化
	 ...
	 * @param obj
	 */
	public QualityTestSpecificationDictionary(JSONObject obj) {
		this();
	...
	public String toString() {
		return "QualityTestSpecificationDictionary [id=" + id + " , name=" + name + " , materialId=" + materialId + " , materialName=" + materialName + " , remark=" + remark + "  ]";
