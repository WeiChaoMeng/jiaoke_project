...
/**
 * quality_test_experimental_value_xjl_sf实体类
 * 
 * @author 
 *
 */
public class QualityTestExperimentalValueXjlSf {
	/***/
	@JSONField(name="id")
	private Integer id;
	/***/
	 ...
	 * 实例化
	 */
	public QualityTestExperimentalValueXjlSf() {
		super();
	}
	/**
	 * 实例化
	 ...
	 * @param obj
	 */
	public QualityTestExperimentalValueXjlSf(JSONObject obj) {
		this();
	...
	public String toString() {
		return "QualityTestExperimentalValueXjlSf [id=" + id + " , orderTicketNum=" + orderTicketNum + " , experimentalId=" + experimentalId + " , experimentalName=" + experimentalName + " , sK132=" + sK132 + " , sK95=" + sK95 + " , sK475=" + sK475 + " , sK236=" + sK236 + " , sK118=" + sK118 + " , sK06=" + sK06 + " , sK03=" + sK03 + " , sK015=" + sK015 + " , sK0075=" + sK0075 + " , sD=" + sD + "  ]";
